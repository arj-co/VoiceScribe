...
export default function PracticePage() {
  return (
    <div className="min-h-screen bg-paper flex flex-col justify-between selection:bg-sage-faint selection:text-ink transition-colors duration-500">
      ...
      <header className="mx-auto max-w-3xl w-full px-6 sm:px-8 pt-8 flex justify-between items-baseline">
        <Link href="/" className="font-display text-xl font-semibold tracking-tight text-ink hover:text-sage transition-colors">
          Voice<em className="not-italic font-bold text-sage">Scribe</em>
        </Link>
      ...
      <footer className="mx-auto max-w-3xl w-full px-6 sm:px-8 py-8 border-t border-rule-light flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-ink-muted">
        <p className="font-display italic text-sm">Built for anyone who wants to speak with more clarity and confidence.</p>
