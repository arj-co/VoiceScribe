      ...
      <main className="flex-1">
        <div className="max-w-6xl mx-auto px-6 py-12 grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <div>
            ...
            {/* SVG Chart */}
            <div className="bg-paper-warm border border-rule rounded-2xl p-2 mb-3">
              <svg
                width="100%"
                viewBox="0 0 620 200"
                    ...
                    >
                      <div>
                        <div className="flex items-center gap-2">
                          <span className="font-mono text-[9px] uppercase tracking-widest bg-paper-deep text-ink-muted px-2 py-0.5 rounded-sm">
                            {session.mode}
                          </span>
          ...
          <div className="lg:sticky lg:top-24">
            ...
            {/* Dysfluency averages */}
            <div className="bg-paper-deep border border-rule-light rounded-2xl p-6 mb-6">
            ...
            {sessions.length > 0 && (() => {
              ...
              return (
                <div className="bg-paper-warm border border-rule rounded-2xl p-6">
